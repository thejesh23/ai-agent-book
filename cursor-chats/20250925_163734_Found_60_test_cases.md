...
Update README for this project to reflect the latest code
...
Update the main agent system prompt to incorporate proactive service in the agent

---

### 🤖 Cursor Assistant

I'll update the agent's system prompt to incorporate proactive service capabilities, enabling the agent to anticipate user needs and provide helpful suggestions beyond what's directly asked.
