...
{\fontsize{33}{41}\selectfont\rmfamily\bfseries Deep Understanding of AI Agents\par}
\vspace{0.5cm}
...
\vfill
{\LARGE\sffamily Li Bojie\par}
\vspace{0.7cm}
{\small\sffamily\color{structurecolor!80} Version v1.1 · \today\par}
\vspace{1.2cm}
\end{titlepage}
