...
The full text and compiled PDF are located in the [`book/`](book/) directory:
...
- **Compiled PDF**: [`book/Deep-Understanding-of-AI-Agents-Li-Bojie-v1.1.pdf`](book/Deep-Understanding-of-AI-Agents-Li-Bojie-v1.1.pdf)
...
2.  **Combine with the Book**: Read the corresponding chapters in the manuscript in the [`book/`](book/) directory of this repository to understand the combination of theory and practice.
